...
const Scoreboard = () => {
    ...
    return (
        <div className="scoreboard-container" style={{
            ...
            <SEO title="Scoreboard - Soul Sync" description="Live game results and leaderboard." name="Soul Sync" type="website" keywords="soul sync scores, couple compatibility results, game winner, relationship sync score, leaderboard" />
